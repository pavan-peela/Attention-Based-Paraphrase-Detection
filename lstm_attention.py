...
from matching import bidirectional_match
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        if os.path.isfile(trained_model_restore):
            ...
            for epoch in range(num_epoch):
                ...
                for step in range(x.sentence_one.shape[0] / batch_size):
                    ...
                    print("Epoch:" + str(epoch + 1) + " Step:" + str(step) + " Loss:" + "{:.4f}".format(
                        loss) + " Batch Acc:" + "{:.4f}".format(acc) + " Mean Batch Acc:" + "{:.4f}".format(
                        sum_acc / i))
        ...
        for step in range(x.sentence_one_test.shape[0] / batch_size):
            ...
            sum_acc += acc
            print("Batch Test Accuracy:" + "{:.4f}".format(acc) + " Mean Batch Test Accuracy:" + "{:.4f}".format(
                sum_acc / i))
